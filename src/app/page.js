...
function ContactUs() {
  return (
    <button
    type="button"
    onClick={() => alert('You Contacted the Person!')}
...
export default function Home() {
  const lines = [
    ...
    "For Premium Indonesian Product"
  ];
  ...
  return (
    ...
    <div className="relative z-10 max-w-2xl">
        ...
        <h1 className="inline-block text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-sky-900 via-purple-500 to-sky-400 bg-clip-text text-transparent my-6">Your Trusted Partner<br />for Premium Indonesian Product</h1>
